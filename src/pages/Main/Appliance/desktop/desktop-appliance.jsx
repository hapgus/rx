...
import { ProductBackgroundShape } from '../../../../components/Shape/ProductBackgroundShape.jsx';
import { PageText } from '../../../../components/Text/Text';
import { FilterProductById, consolidateSpecListsToArray, extractProductNamesFromKeywords, findMatchingProducts } from '../../../../utils/helper-functions';
                    ...
                    <div className={styles.applianceHeaderWrapper}>
                        <div className={styles.applianceHeaderWrapperDiv1}>
                            ...
                            <AnimatedComponent type="wipeEffect" directionStart='left' delay={0.1}>
                                <PageText type='heroTitle'>{details.subtitle}</PageText>
                            </AnimatedComponent>
                ...
                }
                {
                    ...
                    >
                        <div className={styles.sectionTextWrapper}>
                            <PageText type='bodyTitle'>Related Home Appliances</PageText>
                        </div>
