...
import { consolidateSpecListsToArray, extractProductNamesFromKeywords, findMatchingProducts, FilterProductById } from '../../../../utils/helper-functions.js';
                            ...
                            <div className={styles.gridItem1}>
                                <div className={styles.mobileHeaderWrapper}>
                                    ...
                                    <AnimatedComponent type="bounceEffect">
                                        <PageText type='heroSubtitle'>{details.title}</PageText>
                                    </AnimatedComponent>
